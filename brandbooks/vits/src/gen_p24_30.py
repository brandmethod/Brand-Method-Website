...
divider("04","Application",
  ...
  "section is a wireframe: structure fixed, art direction still open.",
...
def zone(label, h, bg="rgba(25,20,16,.05)", fg=INK, border="1px solid rgba(25,20,16,.16)",
    ...
    return (f'<div style="height:{h};background:{bg};border:{border};display:flex;align-items:center;'
            f'justify-content:center;color:{fg};font-family:var(--fm);font-size:11px;'
...
_flavours = [("Chicken", "#C8961E"), ("Curry", "#EC1F28"), ("Tom Yam", "#E2571F"),
...
sheet("4.1 Packaging System", "04 Application", "04 &middot; Application", "4.1 &middot; Packaging System",
  ...
  <div class="rv" style="--d:200ms;display:flex;flex-direction:column">
    <span class="mono s acc" style="margin-bottom:14px">Front of pack, wireframe</span>
    <div style="flex:1;min-height:0;background:var(--paper);border:1px solid var(--ink14);
      ...
      <div style="height:38px;background:{RED};flex:none;display:flex;align-items:center;
        ...
        <span style="position:absolute;left:8px;top:4px;font-family:var(--fm);font-size:10.5px;
      ...
      <div style="flex:none;position:relative;padding-left:0">
        <span style="position:absolute;left:0;top:-2px;font-family:var(--fm);font-size:10.5px;
          color:var(--ink54)">3</span>
        <div style="text-align:center;font-family:var(--ft);font-weight:600;font-size:14px;
      ...
      <div class="slot" style="flex:1;min-height:0;position:relative">
        ...
        <span class="st" style="font-size:15px">Serving image</span>
        <span class="sm" style="font-size:10.5px">Photography to be shot</span></div>
      <div style="display:flex;gap:9px;flex:none;align-items:stretch">
        <div style="flex:1;border:1px dashed rgba(25,20,16,.22);padding:8px 10px;position:relative">
          <span style="position:absolute;left:6px;top:4px;font-family:var(--fm);font-size:10.5px;
            color:var(--ink54)">5</span>
          <div style="font-family:var(--fm);font-weight:700;font-size:17.5px;color:var(--ink);
        ...
        <div style="flex:1.25;border:1px dashed rgba(25,20,16,.22);display:flex;align-items:center;
          ...
          <span style="font-family:var(--fm);font-size:10px;letter-spacing:.1em;color:var(--ink54);
  ...
  <div class="rv" style="--d:280ms;display:flex;flex-direction:column">
    ...
    {"".join(f'''<div style="display:grid;grid-template-columns:30px 1fr;gap:14px;padding:14px 0;
      ...
      <span style="width:24px;height:24px;border-radius:50%;background:{INK};color:#fff;display:flex;
        align-items:center;justify-content:center;font-family:var(--fm);font-size:12.5px;font-weight:700">{n}</span>
      <div><div style="font-family:var(--fd);font-weight:800;font-size:18.5px;letter-spacing:-.01em">{t}</div>
      <div style="font-size:16px;line-height:24px;color:var(--ink72);margin-top:5px">{b}</div></div></div>'''
      for n, t, b in _zones)}
  </div>
  <div class="rv" style="--d:360ms;display:flex;flex-direction:column">
    <span class="mono s acc" style="margin-bottom:14px">Flavour register, draft</span>
    ...
    {"".join(f'''<div style="display:flex;align-items:center;gap:14px">
      ...
      <div style="flex:1"><div style="font-family:var(--fd);font-weight:800;font-size:17.5px">{n}</div>
      <div class="mono s dim" style="margin-top:3px;font-size:11px">{c.upper()}</div></div></div>'''
    ...
    <div style="background:{INK};color:#fff;padding:18px 20px;display:flex;gap:16px;margin-top:20px">
      ...
      <span style="font-size:16px;line-height:24px;color:var(--w72)">Flavour colours are proposed.
...
sheet("4.2 Stationery", "04 Application", "04 &middot; Application", "4.2 &middot; Stationery",
  ...
  <div class="rv" style="--d:200ms;display:flex;flex-direction:column">
    <span class="mono s acc" style="margin-bottom:14px">Letterhead, A4 portrait</span>
    <div style="flex:1;min-height:0;background:var(--paper);border:1px solid var(--ink14);
      ...
      <div style="border-top:1px solid var(--ink14);padding-top:11px;font-family:var(--fm);
        font-size:9px;letter-spacing:.1em;color:var(--ink54);line-height:1.9">
      ...
      <div style="display:flex;flex-direction:column">
        ...
        <div style="flex:1;min-height:0;background:var(--paper);border:1px solid var(--ink14);
          ...
          <div><div style="font-family:var(--fd);font-weight:800;font-size:19px;letter-spacing:-.012em">
            ...
            <div style="font-family:var(--fm);font-size:10.5px;letter-spacing:.09em;color:var(--ink54);
...
sheet("4.3 Retail and Shelf", "04 Application", "04 &middot; Application", "4.3 &middot; Retail and Shelf",
  ...
  <div class="rv" style="--d:200ms;flex:1;min-height:0;display:flex;flex-direction:column">
    <span class="mono s acc" style="margin-bottom:12px">Shelf block, six facings, one brand</span>
    <div style="flex:1;min-height:0;background:var(--paper);border:1px solid var(--ink14);
      ...
      {"".join(f'''<div style="flex:1;display:flex;flex-direction:column;gap:6px;background:{STEAM};
        ...
        <div class="slot" style="flex:1;min-height:0;border-style:dashed">
          <span class="sm" style="font-size:9.5px">Image</span></div>
        <div style="font-family:var(--fm);font-size:9.5px;color:var(--ink54);text-align:center;
  ...
  <div style="flex:none;height:250px;display:grid;grid-template-columns:1.1fr 1fr 1fr;gap:26px">
    ...
    <div class="rv" style="--d:400ms;display:flex;flex-direction:column">
      <span class="mono s acc" style="margin-bottom:12px">Gondola end, header</span>
    ...
    <div class="rv" style="--d:200ms;flex:none;display:flex;flex-direction:column">
      ...
      <div style="background:var(--paper);border:1px solid var(--ink14)">
        ...
        <div class="slot" style="height:132px;border-left:none;border-right:none;border-bottom:none">
          <span class="st">Hero, bowl photography</span>
      ...
      {"".join(f'''<div style="display:flex;flex-direction:column;gap:9px;min-height:0">
        ...
        for bg, jc, inner, cap in [
          (RED, "space-between",
           ...
           "1:1 statement post"),
          (INK, "space-between",
           f'<span class="mono s" style="color:{GOLD};font-size:10.5px">NEW FLAVOUR</span>'
           f'<div class="slot" style="flex:1;min-height:0;margin:8px 0"><span class="sm" style="font-size:10px">Product shot</span></div>'
           f'<span style="font-family:var(--fd);font-weight:800;font-size:17.5px;color:#fff">Italian Mi Goreng</span>',
           "1:1 product post"),
          (PAPER, "space-between",
  ...
  <div style="display:flex;flex-direction:column;gap:24px">
    ...
    <div class="rv" style="--d:400ms;flex:1;min-height:0;display:flex;flex-direction:column">
      ...
      <div style="flex:1;min-height:0;background:var(--paper);border:1px solid var(--ink14);
        ...
        <div style="font-size:16.5px;font-weight:700;color:{INK}">Name Surname</div>
        <div style="font-size:14px;color:var(--ink72);margin-top:2px">Role, Department</div>
        <div style="height:2px;background:{RED};width:38px;margin:12px 0"></div>
        <div style="font-size:13.5px;line-height:1.85;color:var(--ink72)">
          <b style="color:{INK}">Vit Makanan (KL) Sdn Bhd</b><br>
          Rawang, Selangor, Malaysia<br>
          +603 6093 3999 &nbsp;&middot;&nbsp; vitsnoodles.com</div>
        <div style="font-size:12.5px;color:var(--ink54);margin-top:12px">Halal certified since 1980</div>
        <div style="flex:1"></div>
        <div style="border-top:1px solid var(--ink14);padding-top:14px;margin-top:18px;
          font-family:var(--ft);font-size:14.5px;line-height:23px;color:var(--ink72)">
...
_contact = [("Brand governance","Brand Method, appointed agency of record"),
...
sheet("5.1 Contacts and Legal", "05 Close", "05 &middot; Close", "5.1 &middot; Contacts and Legal",
  ...
  <div style="display:flex;flex-direction:column;gap:24px">
    <div class="rv" style="--d:280ms;background:{INK};color:#fff;padding:28px 32px">
      ...
      <div style="font-size:18px;line-height:28px;color:var(--w72);margin-top:14px">
        V1.0 is a <b style="color:#fff">wireframe draft</b>. Structure, hierarchy and copy are
        proposed for review. The mark, the palette and the typeface selection are a design
        proposal. The palette red is sampled from the supplied logo file, which is a single
        colour red mark; the drawn form and the typefaces are not yet reconciled against it, and
        no file in this edition is a production master.</div>
    </div>
    <div class="rv" style="--d:340ms;display:flex;flex-direction:column;gap:16px">
      ...
      {"".join(f'''<div style="display:flex;gap:13px;align-items:baseline;padding-bottom:13px;
        ...
        <span style="font-size:17px;line-height:26px;color:var(--ink72)">{t}</span></div>'''
        for i, t in enumerate([
          "Redraw the mark against the held asset. Vit&rsquo;s Red #EC1F28 is taken from it; "
          "the drawn form here is still a proposal.",
    ...
    <div class="rv" style="--d:420ms;padding-top:16px;border-top:1px solid var(--ink14);
      font-size:15px;line-height:24px;color:var(--ink54)">
...
<div class="cv" style="justify-content:center;z-index:3">
  ...
  <div class="rv" style="--d:200ms;font-size:20px;line-height:32px;color:var(--w72);
    ...
    Vit Makanan (Kuala Lumpur) Sdn Bhd. Rawang, Selangor, Malaysia.
...
<div style="position:absolute;left:120px;bottom:40px;right:120px;z-index:4;display:flex;
  align-items:center;justify-content:space-between;font-family:var(--fm);font-size:12px;
