...
.nav button{border:none;background:transparent;color:rgba(255,255,255,.74);cursor:pointer;
  font-family:var(--fm);font-size:12.5px;letter-spacing:.08em;display:flex;align-items:center;
...
.nav .arr{width:34px;height:34px;font-size:16.5px;flex:none}
...
.nav .dot-i.on{width:24px;height:15px;border-radius:99px;background:var(--gold);color:var(--ink);
  font-family:var(--fm);font-size:10.5px;font-weight:700;display:flex;align-items:center;
  justify-content:center;transform:none}
.nav .dot-i.on:hover{transform:none;background:var(--gold)}

.nname{font-size:12.5px;letter-spacing:.04em;color:#fff;white-space:nowrap;overflow:hidden;
  text-overflow:ellipsis;max-width:210px;flex:none;text-transform:none}
.ncount{font-size:12.5px;letter-spacing:.06em;color:rgba(255,255,255,.64);white-space:nowrap;flex:none}
.ncount b{color:#fff;font-weight:700}

.zm{display:flex;align-items:center;gap:2px;flex:none}
.zm button{width:28px;height:28px;font-size:16.5px}
.zm #zpct{min-width:52px;height:28px;font-size:12px;letter-spacing:.04em;color:#fff}
.zm #zfit{width:auto;padding:0 12px;height:28px;font-size:11.5px;letter-spacing:.1em;
...
.hint{position:fixed;left:22px;bottom:38px;z-index:880;font-family:var(--fm);font-size:11px;
...
.slbar .sub{font-family:var(--fm);font-size:12.5px;letter-spacing:.14em;color:rgba(255,255,255,.46);flex:1;text-transform:uppercase}
.slbar .x{font-family:var(--fm);font-size:12.5px;color:var(--ink);background:var(--gold);padding:8px 16px;
...
.slgroup{grid-column:1/-1;font-family:var(--fm);font-size:11.5px;letter-spacing:.2em;text-transform:uppercase;
...
.slcap{margin-top:9px;font-family:var(--fm);font-size:11px;letter-spacing:.1em;color:rgba(255,255,255,.52);text-transform:uppercase}
...
.pmbox p{font-size:15px;line-height:24px;color:rgba(255,255,255,.66);margin:0 0 22px}
.pmbox p b{color:#fff}
.pmlab{font-family:var(--fm);font-size:11px;letter-spacing:.2em;text-transform:uppercase;color:var(--gold);margin:0 0 10px}
...
.opt{display:flex;align-items:baseline;gap:12px;padding:11px 14px;cursor:pointer;
  border:1px solid rgba(255,255,255,.15);color:rgba(255,255,255,.84);font-size:14.5px}
.opt:hover{background:rgba(255,255,255,.08)}
.opt.sel{border-color:var(--gold);background:rgba(240,168,30,.18);color:#fff}
.opt span{font-family:var(--fm);font-size:11.5px;color:rgba(255,255,255,.48);margin-left:auto}
.pmact{display:flex;gap:10px;justify-content:flex-end}
.pmact button{font-family:var(--fm);font-size:12.5px;letter-spacing:.12em;text-transform:uppercase;
