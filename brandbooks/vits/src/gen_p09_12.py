...
_pillars = [("01","Fifty years of it",
  "Vit&rsquo;s has made noodles since 1975. Not a heritage story bolted on afterwards. The "
...
sheet("2.1 Messaging Pillars", "02 Verbal", "02 &middot; Verbal Identity", "2.1 &middot; Messaging Pillars",
  "Messaging Pillars",
  "Four claims Vit&rsquo;s is entitled to make. Every one carries proof underneath it. If the "
  ...
  {"".join(f'''<div class="card rv" style="--d:{200+i*60}ms;display:flex;flex-direction:column;padding:30px 30px 26px">
    ...
    <p style="font-size:17.5px;line-height:27px">{b}</p>
    ...
    <div style="margin-top:24px;border-top:1px solid var(--ink14);padding-top:16px">
      ...
      {"".join(f"""<div style="display:flex;gap:9px;align-items:baseline;padding:4px 0">
        <span style="color:{RED};font-size:14px;flex:none">&#9679;</span>
        <span style="font-size:16px;line-height:23px;color:var(--ink72)">{p}</span></div>""" for p in ps)}
...
sheet("2.2 Voice and Character", "02 Verbal", "02 &middot; Verbal Identity", "2.2 &middot; Voice and Character",
  ...
  <div style="display:flex;flex-direction:column">
    ...
    {"".join(f'''<div class="rv" style="--d:{230+i*55}ms;padding:20px 0;
      ...
      <div style="font-size:17.5px;line-height:27px;color:var(--ink72);margin-top:8px">{b}</div></div>'''
    ...
    {"".join(f'''<div style="display:grid;grid-template-columns:1fr 1fr;gap:22px;padding:18px 0;
      ...
      <div style="display:flex;gap:11px;align-items:flex-start">
        <span style="flex:none;width:18px;height:18px;border-radius:50%;background:{BROTH};color:#fff;
          display:flex;align-items:center;justify-content:center;font-size:13px;margin-top:2px">&times;</span>
        <span style="font-size:17.5px;line-height:27px;color:var(--ink54);text-decoration:line-through;
      ...
      <div style="display:flex;gap:11px;align-items:flex-start">
        <span style="flex:none;width:18px;height:18px;border-radius:50%;background:{RED};color:#fff;
          display:flex;align-items:center;justify-content:center;font-size:12.5px;margin-top:2px">&#10003;</span>
        <span style="font-size:18px;line-height:27px;color:var(--ink)">{b}</span></div></div>'''
